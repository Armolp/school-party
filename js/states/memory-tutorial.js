var memoryTutorialState = new Kiwi.State( "memoryTutorialState" );

memoryTutorialState.create = function() {

	Kiwi.State.prototype.create.call(this);

	//create background immage
    this.background = new Kiwi.GameObjects.StaticImage( this, this.textures.memoryTut, 0, 0);
...
memoryTutorialState.update = function() {

	Kiwi.State.prototype.update.call( this );

	if(this.sKey.isDown) {
        this.game.states.switchState( "memoryGameState" );
	}
