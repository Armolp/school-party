var mazeTutorialState = new Kiwi.State( "mazeTutorialState" );

mazeTutorialState.create = function() {

	Kiwi.State.prototype.create.call(this);

	//create background immage
    this.background = new Kiwi.GameObjects.StaticImage( this, this.textures.mazeTut, 0, 0);
...
mazeTutorialState.update = function() {
