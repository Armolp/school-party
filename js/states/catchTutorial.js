var catchTutorialState = new Kiwi.State( "catchTutorialState" );

catchTutorialState.create = function() {

	Kiwi.State.prototype.create.call(this);

	//create background immage
    this.background = new Kiwi.GameObjects.StaticImage( this, this.textures.catchTut, 0, 0);
...
catchTutorialState.update = function() {
