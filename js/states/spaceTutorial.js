var spaceTutorialState = new Kiwi.State( "spaceTutorialState" );

spaceTutorialState.create = function() {

	Kiwi.State.prototype.create.call(this);

	//create background immage
    this.background = new Kiwi.GameObjects.StaticImage( this, this.textures.spaceTut, 0, 0);
...
spaceTutorialState.update = function() {
